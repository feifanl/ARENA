...
- [ ] 0.0: Prereqs (PyTorch, einops, einsum)
- [ ] 0.1: Ray tracing (vectorized geometry in PyTorch)
- [ ] 0.2: Convolutional Neural Networks (CNNs) (build ResNet from scratch)
- [ ] 0.3: Optimization (stochastic gradient descent, Adam, schedulers, hyperparam sweeps)
- [ ] 0.4: Backpropagation (build autograd from scratch)
- [ ] 0.5: VAEs and GANs

### Chapter 1: Transformer Interpretability
- [ ] 1.1: Transformer from scratch (GPT-style, attention, MLP, training)
- [ ] 1.2: Intro to mech interp (TransformerLens, induction heads)
- [ ] 1.3.1: Linear probes
- [ ] 1.3.2: Function vectors and model steering
- [ ] 1.3.3: Interpretability with sparse autoencoders (SAEs)
...
- [ ] 1.5.3: OthelloGPT
- [ ] 1.5.4: Toy models of superposition and SAEs
